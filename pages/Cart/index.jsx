...
var itemTotal = item.price * count
  ...
  <div className="product">
    ...
    <button className="qty-btn" onClick={() => setCount((count) => count - 1)}> - </button>
     } {count}
    <button className="qty-btn" onClick={() => setCount((count) => count + 1)}> + </button>
    </div>
    <div className="sub-total">{itemTotal}
...
<button className="i10">{item.use}</button>
</div>
);
  }
...
/*
  ...
  return (
    ...
    <div className="total">
        <div>Thành tiền  </div>
        <div className="i5" >{item0.price * count0 + item1.price * count1}</div>
        <div className="i12">Tổng số tiền (gồm VAT)  </div>
        <div className="i5 i12">{item0.price * count0 + item1.price * count1} </div>
